...
class simulation_env(ParallelEnv):
    ...
    def step(self, actions):
        ...
        self.roadTravelTime, self.roadQueues, self.arrived_vehicles, self.queues_manager = quick_get_new_travel_times(
            self.roadQueues, self.roadVDFS, self.time, self.arrived_vehicles, self.time_out_car, self.queues_manager
        )
